...
delete from ponentes where id = 19;
...
select * from regalos;
select * from eventos;
update registros set regalo_id = 1 where id = 22;
...
ALTER TABLE registros
    ...
    ADD CONSTRAINT `registros_ibfk_3` FOREIGN KEY (`regalo_id`)
...
INSERT INTO usuarios (id, nombre, apellido, email, password, confirmado, admin ) VALUES 
 (1, 'Frank', 'Garcia', 'correo@correo.com', '123456', 1, 1); 
